...
- **Update the README architecture diagram** when a PR adds or removes a module or an edge —
  including un-dashing a box the diagram already reserves for that PR.
