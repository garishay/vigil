...
import { recordingNamed } from '../src/config/recordings.ts'
...
// The casts by role moved to a pure module so the sheet renders in a browser (S6a, #165); every
// name the bench published stays published here, so nothing that reads the bench changed.
export * from './study-spec.ts'
