 ...
 * the Vigil annotations; S5d the pair and the study figure.
 *
...
/** The pair's Queue boxes show this many rows and count the rest; the run's own frame shows every row (S5d). */
