...
describe('the engine carries the score (S5c-ii, #138, ruled C1)', () => {
  ...
  it('reads twenty-six above calm at the 03a Vigil fixture’s freeze, 551 s, with the Queue’s own tags (S7c, #163)', () => {
    ...
    expect(tags).toEqual([
      '1 inject-31 73 · Non-cooperative, closing, near PHL Airfield',
      '2 inject-57 73 · Non-cooperative, closing, near PHL Airfield',
      '3 inject-74 68 · Non-cooperative, closing, near PHL Airfield',
      '4 inject-15 68 · Non-cooperative, closing, near PHL Airfield',
      '5 inject-35 68 · Loitering, non-cooperative, near PHL Airfield',
      '6 inject-65 67 · Non-cooperative, closing, near PHL Airfield',
      '7 inject-94 67 · Non-cooperative, closing, near PHL Airfield',
      '8 inject-62 66 · Loitering, non-cooperative, near PHL Airfield',
      '9 inject-48 65 · Loitering, non-cooperative, near PHL Airfield',
      '10 inject-86 63 · Non-cooperative, closing, near PHL Airfield',
      '11 inject-12 63 · Loitering, non-cooperative, low and slow',
      '12 inject-45 62 · Non-cooperative, closing, low and slow',
      '13 inject-64 61 · Loitering, non-cooperative, low and slow',
      '14 inject-25 61 · Orbiting, non-cooperative, low and slow',
      '15 inject-20 60 · Non-cooperative, closing, low and slow',
      '16 inject-85 59 · Non-cooperative, closing, low and slow',
      '17 inject-58 57 · Non-cooperative, closing, low and slow',
      '18 inject-52 54 · Non-cooperative, closing, low and slow',
      '19 inject-36 51 · Non-cooperative, near PHL Airfield, low and slow',
      '20 inject-60 51 · Non-cooperative, near PHL Airfield, low and slow',
      '21 inject-91 50 · Non-cooperative, near PHL Airfield, low and slow',
      '22 inject-22 49 · Non-cooperative, near PHL Airfield, low and slow',
      '23 inject-56 48 · Non-cooperative, near PHL Airfield, low and slow',
      '24 inject-84 47 · Non-cooperative, low and slow, near PHL Airfield',
      '25 inject-120 45 · Closing, near PHL Airfield, low and slow',
      '26 inject-47 45 · Non-cooperative, low and slow, near PHL Airfield',
    ])
  })
})
