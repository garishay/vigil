 ...
 * the marker, its label and its tick dropped to a grey plainly between the neutral (`#c5cfdc`)
 * and a hollow marker's ground. The map paints it and the brief's legend draws it, from this one
